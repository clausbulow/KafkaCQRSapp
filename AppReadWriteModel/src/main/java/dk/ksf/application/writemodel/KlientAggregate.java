...
public class KlientAggregate {
    ...
    @CommandHandler
    public KlientRettetObject RetKlientCommand(MessageContext context, RetKlientCommand command) throws Exception {
    ...
    public void onKlientRettetEvent(MessageContext context, KlientRettetObject event) throws Exception {
        ...
        cpr = event.getCpr();
        version = context.getVersion();
        log.info("Klient rettet i dk.ksf.application.writemodel");
    }
}
